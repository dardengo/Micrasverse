...
void Plot::draw(micrasverse::physics::Box2DMicrasBody& micrasBody){
    ...
    rdata7.addPoint(t, micrasBody.getDistanceSensor(0).getReading());
    rdata8.addPoint(t, micrasBody.getDistanceSensor(1).getReading());
    rdata9.addPoint(t, micrasBody.getDistanceSensor(2).getReading());
    rdata10.addPoint(t, micrasBody.getDistanceSensor(3).getReading());
